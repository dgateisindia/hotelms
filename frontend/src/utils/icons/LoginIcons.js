// ============================================================
//  LoginIcons.js — All SVG icons used in the Login page
// ============================================================

export const IconBed = () => (
  <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12V7a1 1 0 011-1h16a1 1 0 011 1v5M3 12h18M3 12v5a1 1 0 001 1h16a1 1 0 001-1v-5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 12V9h10v3" />
  </svg>
);

export const IconUsers = () => (
  <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a4 4 0 00-5-3.87M9 20H4v-2a4 4 0 015-3.87M16 7a4 4 0 11-8 0 4 4 0 018 0zM22 20v-2a4 4 0 00-3-3.87" />
  </svg>
);
...
export const IconChart = () => (
  <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.94 11A9 9 0 0013 3.06V11h7.94z" />
  </svg>
);
